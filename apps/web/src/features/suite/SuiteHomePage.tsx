    ...
    return (
      <section className="rounded-lg border border-border bg-card p-6">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Your product access could not be resolved. Ask a tenant administrator
    ...
    <div className="space-y-6">
      <section className="rounded-xl border border-primary/30 bg-gradient-to-br from-primary/15 via-background to-background p-6 sm:p-8">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">
          Your workspace is tailored to the products and responsibilities
          assigned to you.
        </p>
        <div className="mt-5">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        <article className="rounded-lg border bg-card p-5">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Review the commitments, follow-ups, and risks assigned to you in
            CommitArc.
          </p>
          {products.commitarc.visible ? (
            <Link
              className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-primary"
              to={products.commitarc.href as never}
            >
        ...
        <article className="rounded-lg border bg-card p-5">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            RevenueOS Essentials highlights the next safe action using only
            records you may access.
          </p>
          {products.revenueos.visible ? (
            <p className="mt-4 text-sm font-medium text-primary">
              RevenueOS{" "}
              {products.revenueos.mode === "ESSENTIALS" ? "Essentials" : ""}
            </p>
          ) : null}
        ...
        <article className="rounded-lg border bg-card p-5">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Products without an active entitlement are not shown or reachable
            from this workspace.
          </p>
          {canManageCampaigns ? (
            <Link
